...
import ma.nawar.pharmarket.config.audit.AuditEventConverter;
import ma.nawar.pharmarket.domain.PersistentAuditEvent;
...
import static ma.nawar.pharmarket.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
